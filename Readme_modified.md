...
In short, I modify the gene names in the adata object by adding a prefix of 4 characters ('AER_' in this case but it could be anything that is not containing in any gene in the genome) and remove the prefix before exporting the results.
